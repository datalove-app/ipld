...
use crate::dev::*;
// use ipld_macros_internals::SchemaDefinition;
...
pub trait RepresentationExt<T>: Representation
where
    T: Representation,
{
...
// /// Extension trait to add runtime type validation
// pub trait ValidateRepresentation<Ctx>: Representation<Ctx>
// where
//     Ctx: Context + Sync,
// {
//     fn validate<E>(&self) -> Result<(), E> {
//         Ok(())
//     }
// }
